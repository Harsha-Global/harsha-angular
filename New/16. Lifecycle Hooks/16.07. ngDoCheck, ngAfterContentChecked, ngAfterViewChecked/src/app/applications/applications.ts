...
export class Applications implements OnInit, AfterViewInit, OnDestroy, AfterViewChecked
{
  ...
  ngAfterViewInit(): void
  {
    ...
    this.pollingSubscription = interval(2000).subscribe({
      next: (): void => {
        console.log('Polling from applications component.');
      }
    });
  ...
  ngOnDestroy(): void
  {
    console.log('Applications component - ngOnDestroy.');
  ...
  {
    console.log('Applications component - After view checked fired');  
  }
}
