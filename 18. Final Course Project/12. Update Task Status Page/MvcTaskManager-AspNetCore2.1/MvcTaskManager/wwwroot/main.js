...
/* harmony import */ var src_app_services_projects_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/projects.service */ "./src/app/services/projects.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var src_app_services_task_priorities_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/task-priorities.service */ "./src/app/services/task-priorities.service.ts");
...
var CreateTaskComponent = /** @class */ (function () {
    function CreateTaskComponent(tasksService, router, projectsService, taskPrioritiesService, loginService) {
    ...
    CreateTaskComponent.prototype.ngOnInit = function () {
        this.newTaskForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            taskID: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](0),
            taskName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            description: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, []),
            projectID: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            assignedTo: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            taskPriorityID: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](2, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])
        });
        this.projects = this.projectsService.getAllProjects();
        this.employees = this.loginService.getAllEmployes();
        this.taskPriorities = this.taskPrioritiesService.getTaskPriorities();
    };
    CreateTaskComponent.prototype.onCreateTaskClick = function (event) {
        var _this = this;
        this.newTaskForm["submitted"] = true;
        if (this.newTaskForm.valid) {
            this.tasksService.insertTask(this.newTaskForm.value).subscribe(function () {
                _this.router.navigate(["/employee", "tasks"]);
            }, function (error) {
                console.log(error);
            });
    ...
    CreateTaskComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_tasks_service__WEBPACK_IMPORTED_MODULE_3__["TasksService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], src_app_services_projects_service__WEBPACK_IMPORTED_MODULE_4__["ProjectsService"], src_app_services_task_priorities_service__WEBPACK_IMPORTED_MODULE_6__["TaskPrioritiesService"], src_app_services_login_service__WEBPACK_IMPORTED_MODULE_7__["LoginService"]])
    ], CreateTaskComponent);
...
var TasksComponent = /** @class */ (function () {
    function TasksComponent(tasksService, loginService) {
        this.tasksService = tasksService;
        this.loginService = loginService;
    }
    TasksComponent.prototype.ngOnInit = function () {
        ...
        this.tasksService.getTasks().subscribe(function (response) {
            _this.taskGroups = response;
        });
    };
    /* Get background color based on task status */
    TasksComponent.prototype.getTaskGroupBgCssClass = function (taskStatusName) {
        var className;
    ...
    TasksComponent.prototype.getTaskPriorityBadgeCssClass = function (taskPriorityName) {
        var className;
    ...
    TasksComponent.prototype.getTaskGroupTextCssClass = function (taskStatusName) {
        var className;
        switch (taskStatusName) {
            case "Holding":
    ...
    TasksComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_tasks_service__WEBPACK_IMPORTED_MODULE_2__["TasksService"], _services_login_service__WEBPACK_IMPORTED_MODULE_3__["LoginService"]])
    ], TasksComponent);
...
/* harmony import */ var _models_TaskStatusDetail__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../models/TaskStatusDetail */ "./src/app/models/TaskStatusDetail.ts");
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services_task_statuses_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../services/task-statuses.service */ "./src/app/services/task-statuses.service.ts");
...
var UpdateTaskStatusComponent = /** @class */ (function () {
    function UpdateTaskStatusComponent(tasksService, router, taskStatuesService, activatedRoute) {
        this.tasksService = tasksService;
        this.router = router;
        this.taskStatuesService = taskStatuesService;
        this.activatedRoute = activatedRoute;
        this.currentTask = new _models_task__WEBPACK_IMPORTED_MODULE_2__["Task"]();
        this.currentTaskStatusDetail = new _models_TaskStatusDetail__WEBPACK_IMPORTED_MODULE_3__["TaskStatusDetail"]();
    }
    UpdateTaskStatusComponent.prototype.ngOnInit = function () {
        ...
        this.editTaskStatusForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
            thisStatusDetailID: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](0),
            taskID: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](null),
            taskStatusID: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](null, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]),
        ...
        //get task by taskid
        this.tasksService.getTaskByTaskID(this.taskID).subscribe(function (task) {
            _this.currentTask = task;
            //Load task details into Reactive form
            _this.currentTaskStatusDetail.taskID = _this.taskID;
            _this.currentTaskStatusDetail.description = null;
            _this.currentTaskStatusDetail.taskStatusID = task.currentTaskStatusID;
            _this.currentTaskStatusDetail.taskStatusDetailID = 0;
            _this.editTaskStatusForm.patchValue(_this.currentTaskStatusDetail);
        });
    };
    UpdateTaskStatusComponent.prototype.onUpdateTaskStatusClick = function (event) {
        var _this = this;
        this.editTaskStatusForm["submitted"] = true;
        if (this.editTaskStatusForm.valid) {
            //send REST-API call to server
            this.tasksService.updateTaskStatus(this.editTaskStatusForm.value).subscribe(function (response) {
                _this.router.navigate(["/employee", "tasks"]);
            }, function (error) {
                console.log(error);
            });
    ...
    UpdateTaskStatusComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_tasks_service__WEBPACK_IMPORTED_MODULE_5__["TasksService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _services_task_statuses_service__WEBPACK_IMPORTED_MODULE_7__["TaskStatusesService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"]])
...
/***/ "./src/app/models/TaskStatusDetail.ts":
/*!********************************************!*\
  !*** ./src/app/models/TaskStatusDetail.ts ***!
  \********************************************/
...
var TaskStatusDetail = /** @class */ (function () {
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.detectIfAlreadyLoggedIn = function () {
    ...
    LoginService.prototype.getAllEmployes = function () {
        this.httpClient = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"](this.httpBackend);
...
var TaskPrioritiesService = /** @class */ (function () {
    function TaskPrioritiesService(httpClient) {
        this.httpClient = httpClient;
    }
    TaskPrioritiesService.prototype.getTaskPriorities = function () {
        return this.httpClient.get("/api/taskpriorities", { responseType: "json" });
    };
    TaskPrioritiesService.prototype.getTaskPrioritytByTaskPriorityID = function (TaskPriorityID) {
        return this.httpClient.get("/api/taskpriorities/searchbytaskpriorityid/" + TaskPriorityID, { responseType: "json" });
    };
    TaskPrioritiesService.prototype.insertTaskPriority = function (newTaskPriority) {
        return this.httpClient.post("/api/taskpriorities", newTaskPriority, { responseType: "json" });
    };
    TaskPrioritiesService.prototype.updateTaskPriority = function (existingTaskPriority) {
        return this.httpClient.put("/api/taskpriorities", existingTaskPriority, { responseType: "json" });
    };
    TaskPrioritiesService.prototype.deleteTaskPriority = function (TaskPriorityID) {
        return this.httpClient.delete("/api/taskpriorities?TaskPriorityID=" + TaskPriorityID);
    };
    TaskPrioritiesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
...
var TaskStatusesService = /** @class */ (function () {
    function TaskStatusesService(httpClient) {
        this.httpClient = httpClient;
    }
    TaskStatusesService.prototype.getTaskStatuses = function () {
        return this.httpClient.get("/api/taskstatuses", { responseType: "json" });
    };
    TaskStatusesService.prototype.getTaskStatusByTaskStatusID = function (TaskStatusID) {
        return this.httpClient.get("/api/taskstatuses/searchbytaskstatusid/" + TaskStatusID, { responseType: "json" });
    };
    TaskStatusesService.prototype.insertTaskStatus = function (newTaskStatus) {
        return this.httpClient.post("/api/taskstatuses", newTaskStatus, { responseType: "json" });
    };
    TaskStatusesService.prototype.updateTaskStatus = function (existingTaskStatus) {
        return this.httpClient.put("/api/taskstatuses", existingTaskStatus, { responseType: "json" });
    };
    TaskStatusesService.prototype.deleteTaskStatus = function (TaskStatusID) {
        return this.httpClient.delete("/api/taskstatuses?TaskStatusID=" + TaskStatusID);
    };
    TaskStatusesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
...
var TasksService = /** @class */ (function () {
    ...
    TasksService.prototype.getTaskByTaskID = function (TaskID) {
        return this.httpClient.get("/api/tasks/searchbytaskid/" + TaskID, { responseType: "json" });
    };
    TasksService.prototype.updateTaskStatus = function (taskStatusDetail) {
        return this.httpClient.put("/api/updatetaskstatus", taskStatusDetail, { responseType: "json" });
    };
    TasksService.prototype.insertTask = function (newTask) {
