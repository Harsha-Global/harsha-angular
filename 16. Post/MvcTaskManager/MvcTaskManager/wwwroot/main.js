...
var ProjectsComponent = /** @class */ (function () {
    ...
    ProjectsComponent.prototype.onSaveClick = function () {
        ...
        this.projectsService.insertProject(this.newProject).subscribe(function (response) {
            _this.newProject.projectID = response.projectID;
            _this.newProject.projectName = response.projectName;
            _this.newProject.dateOfStart = response.dateOfStart;
            _this.newProject.teamSize = response.teamSize;
            _this.projects.push(_this.newProject);
