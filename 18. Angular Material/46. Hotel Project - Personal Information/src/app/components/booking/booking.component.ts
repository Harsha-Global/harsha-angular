...
export class BookingComponent implements OnInit
{
  ...
  constructor(private citiesService: CitiesService, private hotelsService: HotelsService, private roomTypesService: RoomTypesService, private countriesService: CountriesService)
  {
    //formgroup
