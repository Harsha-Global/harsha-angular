...
export class ChangeDatesComponent implements OnInit
{
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public dialogData: Booking, public matDialogRef: MatDialogRef<ChangeDatesComponent>, private bookingsService: BookingsService)
  {
