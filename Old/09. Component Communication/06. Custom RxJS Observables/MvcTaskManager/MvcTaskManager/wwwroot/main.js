...
var ProjectComponent = /** @class */ (function () {
    ...
    ProjectComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.projectsService.MyObservable.subscribe(function (hide) {
...
var ProjectsService = /** @class */ (function () {
    function ProjectsService(httpClient) {
        ...
        this.MyObservers = [];
        this.hideDetails = false;
        this.MyObservable = rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (observer) {
            _this.MyObservers.push(observer);
        });
    }
    ProjectsService.prototype.toggleDetails = function () {
        this.hideDetails = !this.hideDetails;
        for (var i = 0; i < this.MyObservers.length; i++) {
